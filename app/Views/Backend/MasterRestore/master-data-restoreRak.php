<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-body">
						<h3>Restore Data Rak <a href="<?= base_url('admin/input-data-rak'); ?>"></a></h3>
						<hr />
							...
							<tbody>
								...
								<tr>
									...
									<td data-sortable="true">
										...
										<a href="#" onclick="doDelete('<?= sha1($data['id_rak']);?>')"><button type="button" class="btn btn-sm btn-success">Restore</button></a>
									</td>
								</tr>
								<?php } ?>
							</tbody>
	...
	<script type="text/javascript">
		function doDelete(idDelete){
			...
			.then(ok => {
				if(ok){
					window.location.href = '<?= base_url();?>/admin/restore-data-rak/' + idDelete;
				}
				else{
